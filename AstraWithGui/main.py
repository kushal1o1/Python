...
hr = int(time.strftime('%H'))
chatstr = "I am virtual assistant ASTRA created by kushal\n Please tell me how can I help you Today?\n"
chatstr2 = ""
action = "ASTRA"
...
class MainThread(QThread):
    ...
    def run(self):
        ...
        while True:
            ...
            if 'wake up' or 'hey astra' or 'astra' or 'dost' in self.query.lower():
                self.MAIN()
    ...
    def takeCommand(self):
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                returntext("ASTRA > Sorry Boss,I dont get it? ")
                return " "
    ...
    def MAIN(self):
        ...
        while x == 1:
            ...
            if "astra" in self.query.lower():
                self.speakfunc("yes,What can i do for you boss")
            ...
            if "clear the screen" in self.query.lower():
                ...
                self.speakfunc("OK,Boss Have a great day")
                x = False
